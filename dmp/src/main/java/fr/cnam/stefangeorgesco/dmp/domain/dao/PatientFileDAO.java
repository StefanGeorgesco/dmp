...
/**
 * Repository pour les objets {@link fr.cnam.stefangeorgesco.dmp.domain.model.PatientFile}
 * 
...
public interface PatientFileDAO extends CrudRepository<PatientFile, String> {
	...
	/**
	 * Recherche les dossiers patients par recherche insensible à la casse
	 * de la présence d'une sous-chaîne dans l'identifiant du dossier ou dans le prénom 
	 * ou dans le nom du patient.
	 * @param keyword la sous-chaîne de recherche.
	 * @return un {@link java.lang.Iterable} d'objets
	 * {@link fr.cnam.stefangeorgesco.dmp.domain.model.PatientFile} représentant les dossiers
	 * patients trouvés.
	 */
