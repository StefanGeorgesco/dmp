...
public class UserController {
	 ...
	 * {@link fr.cnam.stefangeorgesco.dmp.authentication.domain.dto.UserDTO} représentant le
	...
	/**
	 * Gestionnaire des requêtes POST d'identification / authentification de l'utilisateur
	 * (login)
